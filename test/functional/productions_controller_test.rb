...
class ProductionsControllerTest < ActionController::TestCase
  ...
  test "should create production" do
    assert_difference('Production.count') do
      post :create, production: { fg_ukey: @production.fg_ukey, plannedtime: @production.plannedtime, staff: @production.staff }
    end
  ...
  test "should update production" do
    put :update, id: @production, production: { fg_ukey: @production.fg_ukey, plannedtime: @production.plannedtime, staff: @production.staff }
    assert_redirected_to production_path(assigns(:production))
  end
